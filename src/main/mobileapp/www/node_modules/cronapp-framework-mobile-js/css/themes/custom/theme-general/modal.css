...
#modalBodyConfirmDialog .title {
    font-size: var(--textExtraBigSize, 18px);
    font-weight: bold;
    line-height: 1;
}
...
.k-button.k-primary.k-state-hover, .k-button.k-primary:hover {
    border-color: var(--colorPrimary40, #ff6b58);
    color: var(--textColorPrimary40, #fff);
    background-color: var(--colorPrimary40, #ff6b58);
    background-image: linear-gradient(var(--colorPrimary10, rgba(255,146,88,.0)), var(--colorPrimary20, rgba(255,146,88,.2)));
  }
  
  .k-dialog-button-layout-stretched .k-primary:not(:hover):not(.k-state-hover):not(:active):not(.k-state-active) {
      color: var(--colorPrimary40, #ff6b58);
  }
  ...
  .k-button.k-primary.k-state-active, .k-button.k-primary:active {
      ...
      color: var(--textColorPrimary40, #fff);
      background-color: var(--colorPrimary40, #ff6b58);
      background-image: linear-gradient(var(--colorPrimary10, rgba(255,138,88,.2)), var(--colorPrimary20, rgba(255,138,88,0)));
  ...
  .k-dialog-button-layout-stretched .k-button.k-primary.k-state-focused, .k-dialog-button-layout-stretched .k-button.k-primary:focus {
      box-shadow: inset 0 0 0 2px var(--colorPrimary10, rgb(255 99 88 / 30%));
  }
  ...
  .k-dialog[data-dialog-type="error"] .k-dialog-titlebar:before {
    background-color: var(--colorDanger40, #ff6358);
    color: var(--textColorDanger40, #fff);
  }
  ...
  .k-dialog[data-dialog-type="success"] .k-dialog-titlebar:before {
    background-color: var(--colorSuccess40, #ff6358);
    color: var(--textColorSuccess40, #fff);
  }
  ...
  .k-dialog[data-dialog-type="warning"] .k-dialog-titlebar:before {
    background-color: var(--colorWarning40, #ff6358);
    color: var(--textColorWarning40, #fff);
  }
  ...
  .k-dialog[data-dialog-type="info"] .k-dialog-titlebar:before {
    background-color: var(--colorPrimary40, #ff6358);
    color: var(--textColorPrimary40, #fff);
  }
