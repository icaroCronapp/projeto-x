...
div.crn-ion-segment-modern ul.active-background-default li.active {
    background:  linear-gradient(var(--colorDefault30, #82bded), var(--colorDefault40, #2fa4e7));
...
div.crn-ion-segment-modern ul.active-background-assertive li.active {
    background:  linear-gradient(var(--colorDanger40, #ef473a), var(--colorDanger50, #ae191e));
...
div.crn-ion-segment-modern ul.active-background-balanced li.active {
    background:  linear-gradient(var(--colorSuccess30, #73a839), var(--colorSuccess40, #73a839));
...
div.crn-ion-segment-modern ul.active-background-energized li.active {
    background:  linear-gradient(var(--colorWarning30, #e5907b), var(--colorWarning40, #dd5600));
...
div.crn-ion-segment-modern ul.active-background-light li.active {
    background:  linear-gradient(var(--colorLight30, #ffffff), var(--colorLight40, #ffffff));
...
div.crn-ion-segment-modern ul.active-background-calm li.active {
    background:  linear-gradient(var(--colorCalm30, #7cd1f6), var(--colorCalm40, #11c1f3));
...
div.crn-ion-segment-modern ul.active-background-positive li.active {
    background:  linear-gradient(var(--colorPrimary30, #eef1f3), var(--colorPrimary40, #e9ecef));
    border-color: var(--colorPrimary40, #e9ecef);
}
...
div.crn-ion-segment-modern ul.active-background-royal li.active {
    background:  linear-gradient(var(--colorRoyal30, #ab9aef), var(--colorRoyal40, #886aea));
