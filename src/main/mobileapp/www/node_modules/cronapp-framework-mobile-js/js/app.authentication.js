            ...
            if (window.customStateProvider) {
                ...
                $stateProvider
                    ...
                    .state('public', {
                        ...
                        templateUrl: 'node_modules/cronapp-framework-mobile-js/components/templates/public.menu.template.html'
                    })

                    .state('reset-password', {
                        url: "/app/public/reset-password",
                        cache: false,
          ...
          $rootScope.$stateParams = $stateParams;
            ...
            $rootScope.$on('$stateChangeSuccess', function(event, currentRoute, previousRoute) {
              ...
              $timeout(() => {
                ...
                let splitedHash = window.location.hash ? window.location.hash.split('\/') : "";
                let pageName = splitedHash ? splitedHash[splitedHash.length-1] : "";
...
app.publicRoutes = ["publicRoot", "public", "public.pages", "signup", "main", "reset-password"];
