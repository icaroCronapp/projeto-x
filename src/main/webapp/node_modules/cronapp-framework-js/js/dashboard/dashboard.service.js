(function($app) {
  angular.module('dashboard.services', []).service('DashboardService', function($http, $compile, $modal, $translate, $window, $rootScope) {
    ...
    var scriptsStimulsoft = [
      'node_modules/cronapp-lib-js/dist/js/stimulsoft/stimulsoft.vendor.css',
      'node_modules/cronapp-lib-js/dist/js/stimulsoft/stimulsoft.vendor.js',
    ...
    this.openStimulsoftDashboard = function(json, parameters, datasourcesInBand, config) {
      ...
      var getViewer = () => {
        ...
        if(Stimulsoft.Viewer.StiJsViewer.prototype.IsTouchDevice()) {
