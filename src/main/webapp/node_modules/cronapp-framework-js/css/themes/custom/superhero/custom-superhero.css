...
:root {
    ...
    /* Background Login*/
    --backgroundLogin10: #d7d8da;
    --backgroundLogin20: #b0b3b7;
    --backgroundLogin30: #81878e;
    --backgroundLogin40: #2b3e50;
    --backgroundLogin50: #263646;
    --backgroundLogin60: #202d3b;
    --backgroundLogin70: #18222c;
    ...
    /* Components - Button */
    --btnLink: var(--colorPrimary40, #df691a);
    --btnDefault: var(--colorDefault40, #4e5d6c);
    --btnPrimary: var(--colorPrimary40, #df691a);
    --btnSuccess: var(--colorSuccess40, #5cb85c);
    --btnCalm: var(--colorCalm40, #5bc0de);
    --btnWarning: var(--colorWarning40, #f0ad4e);
    --btnDanger: var(--colorDanger40, #d9534f);
    --btnLight: var(--colorLight40, #abb6c2);
    --btnStable: var(--colorStable40, #f8f8f8);
    --btnRoyal: var(--colorRoyal40, #886aea);
    --btnDark: var(--colorDark40, #20374c);
    ...
    --colorDefault: var(--colorDefault30, #8d949b);
    --colorPrimary: var(--colorPrimary40, #df691a);
    --colorSuccess: var(--colorSuccess40, #5cb85c);
    --colorCalm: var(--colorCalm40, #5bc0de);
    --colorWarning: var(--colorWarning40, #f0ad4e);
    --colorDanger: var(--colorDanger40, #d9534f);
    --colorLight: var(--colorLight40, #abb6c2);
    --colorStable: var(--colorStable40, #f8f8f8);
    --colorRoyal: var(--colorRoyal40, #886aea);
    --colorDark: var(--colorDark30, #7e848c);

    /* Components - Checkbox */
    --checkboxDefault: var(--colorDefault20, #b7babf);
    --checkboxPrimary: var(--colorPrimary40, #df691a);
    --checkboxSuccess: var(--colorSuccess40, #5cb85c);
    --checkboxCalm: var(--colorCalm40, #5bc0de);
    --checkboxWarning: var(--colorWarning40, #f0ad4e);
    --checkboxDanger: var(--colorDanger40, #d9534f);
    --checkboxLight: var(--colorLight40, #abb6c2);
    --checkboxStable: var(--colorStable40, #f8f8f8);
    --checkboxRoyal: var(--colorRoyal40, #886aea);
    --checkboxDark: var(--colorDark30, #7e848c);

    --borderCheckboxDefault: var(--colorDefault30, #dfdfdf);
    --borderCheckboxPrimary: var(--colorPrimary40, #df691a);
    --borderCheckboxSuccess: var(--colorSuccess40, #5cb85c);
    ...
    --borderCheckboxLight: var(--colorLight40, #abb6c2);
    --borderCheckboxStable: var(--colorStable40, #f8f8f8);
    --borderCheckboxRoyal: var(--colorRoyal40, #886aea);
    --borderCheckboxDark: var(--colorDark30, #7e848c);

    /* Components - Combobox */
    --comboboxDefault: var(--colorDefault40, #4e5d6c);
    --comboboxPrimary: var(--colorPrimary40, #df691a);
    --comboboxSuccess: var(--colorSuccess40, #5cb85c);
    --comboboxCalm: var(--colorCalm40, #5bc0de);
    --comboboxWarning: var(--colorWarning40, #f0ad4e);
    --comboboxDanger: var(--colorDanger40, #d9534f);
    --comboboxLight: var(--colorLight40, #abb6c2);
    --comboboxStable: var(--colorStable40, #f8f8f8);
    --comboboxRoyal: var(--colorRoyal40, #886aea);
    --comboboxDark: var(--colorDark40, #20374c);

    --borderComboboxDefault: var(--colorDefault50, #44515f);
    --borderComboboxPrimary: var(--colorPrimary50, #c35c17);
    --borderComboboxSuccess: var(--colorSuccess50, #51a151);
    --borderComboboxCalm: var(--colorCalm50, #50a8c2);
    --borderComboboxWarning: var(--colorWarning50, #d29744);
    --borderComboboxDanger: var(--colorDanger50, #be4945);
    --borderComboboxLight: var(--colorLight50, #969faa);
    --borderComboboxStable: var(--colorStable50, #d9d9d9);
    --borderComboboxRoyal: var(--colorRoyal50, #775dcd);
    --borderComboboxDark: var(--colorDark50, #1c3043);

    /* Components - Radio input */
    --optionDefault: var(--colorDefault40, #4e5d6c);
    --optionPrimary: var(--colorPrimary40, #df691a);
    --optionSuccess: var(--colorSuccess40, #5cb85c);
    --optionCalm: var(--colorCalm40, #5bc0de);
    --optionWarning: var(--colorWarning40, #f0ad4e);
    --optionDanger: var(--colorDanger40, #d9534f);
    --optionLight: var(--colorLight40, #abb6c2);
    --optionStable: var(--colorStable40, #f8f8f8);
    --optionRoyal: var(--colorRoyal40, #886aea);
    --optionDark: var(--colorDark30, #7e848c);

    --borderOptionDefault: var(--colorDefault30, #dfdfdf);
    --borderOptionPrimary: var(--colorPrimary40, #df691a);
    --borderOptionSuccess: var(--colorSuccess40, #5cb85c);
    ...
    --borderOptionLight: var(--colorLight40, #abb6c2);
    --borderOptionStable: var(--colorStable40, #f8f8f8);
    --borderOptionRoyal: var(--colorRoyal40, #886aea);
    --borderOptionDark: var(--colorDark30, #7e848c);

    /* Components - Panel */
    --panelDefault: var(--colorPrimary40, #df691a);
    --panelPrimary: var(--colorDefault50, #44515f);
    --panelSuccess: var(--colorSuccess40, #5cb85c);
    --panelCalm: var(--colorCalm40, #5bc0de);
    --panelWarning: var(--colorWarning40, #f0ad4e);
    --panelDanger: var(--colorDanger40, #d9534f);
    --panelLight: var(--colorLight40, #abb6c2);
    --panelStable: var(--colorStable40, #f8f8f8);
    --panelRoyal: var(--colorRoyal40, #886aea);
    --panelDark: var(--colorDark30, #7e848c);
...
.color-dark {
    color: var(--colorDark30, #7e848c);
}

.color-dark:hover {
    color: var(--colorDark20, #afb2b6);
}

.color-default {
    color: var(--colorDefault30, #8d949b);
}

.color-default:hover {
    color: var(--colorDefault20, #b7babf);
}
...
a:active,
a:hover {
    color: var(--colorPrimary60, #a34d13);
}

/* menu */
.dropdown-menu {
    background: var(--colorDefault40, #4e5d6c);
    color: var(--textColor40, #ebebeb);
}
...
.k-dialog .k-dialog-buttongroup.k-dialog-button-layout-normal {
    background: var(--colorDefault60, #39444f);
    border-color: var(--colorDefault60, #39444f);
}
...
.modal-header,
.modal-footer {
    background: var(--colorDefault50, #44515f);
    border: none;
}
...
.siginPanel,
.login-view {
    background: var(--backgroundLogin40, #2b3e50);
}
...
.login-view .btn.btn-default {
    background: var(--colorPrimary40, #df691a);
...
.login-view .btn.btn-default:hover {
    color: var(--textColorPrimary40, #ffffff);
    background: var(--colorPrimary50, #c35c17);
    border-color: transparent;
    outline: none;
}

.bg-login #container-second {
    background: linear-gradient(-140deg, var(--colorPrimary20, #eebeaf), var(--colorPrimary30, #e79a7d), var(--colorPrimary40, #df691a), var(--colorPrimary50, #c35c17), var(--colorPrimary60, #a34d13));
}
...
.bg-login #container-first {
    ...
    border-color: var(--colorDefault50, #44515f);
    box-shadow: none;
}
...
.dynamic-image-container {
    border: 2px dashed var(--colorDefault10, #dadbdd);
    padding: 10px;
}
...
.k-grid-toolbar .k-button {
    border: 1px solid var(--colorDefault20, #b7babf);
}
...
.k-grid {
    border-color: var(--backgroundColor30, #81878e);
}
...
.active-bar .btn.btn-default {
    background: var(--colorSuccess40, #5cb85c);
    border-color: transparent;
...
.active-bar .btn.btn-default:hover {
    background: var(--colorSuccess50, #51a151);
    border-color: transparent;
    color: var(--textColorSuccess40, #ffffff);
}
...
cron-calendar.k-widget {
    border-color: var(--backgroundColor40, #2b3e50);
}
...
.k-calendar th {
    background: var(--colorDefault10, #dadbdd);
}
...
.k-state-selected {
    box-shadow: inset 0 0 10px 3px var(--colorDefault30, #8d949b);
    color: var(--colorDefault40, #4e5d6c);
}
...
.bootstrap-datetimepicker-widget table td.new {
    color: var(--colorDefault30, #ffffff);
}

/* seta do modal do calendario */
.bootstrap-datetimepicker-widget.dropdown-menu.bottom:after {
    border-bottom-color: var(--colorNeutral00, #ffffff);
}
...
.table-hover>tbody>tr:hover {
    background: var(--textColorDefault20, #bbbbbb);
    color: var(--colorDefault40, #4e5d6c);
}
...
.checkbox-default .k-checkbox-label:before {
    border-color: var(--colorDefault30, #8d949b);
}
...
.checkbox-default .k-checkbox:focus+.k-checkbox-label:before,
.checkbox-default .k-checkbox:hover+.k-checkbox-label:before {
    box-shadow: 0 0 5px 0 var(--colorDefault20, #b7babf);
}
...
.checkbox-default .k-checkbox:checked+.k-checkbox-label:after,
.checkbox-default .k-checkbox:indeterminate+.k-checkbox-label:after {
    background: var(--colorDefault20, #8d949b);
    color: var(--textColorDefault40, #ffffff);
}
...
.checkbox-dark .k-checkbox-label:before {
    border-color: var(--colorDark30, #7e848c);
}
...
.checkbox-dark .k-checkbox:focus+.k-checkbox-label:before,
.checkbox-dark .k-checkbox:hover+.k-checkbox-label:before {
    box-shadow: 0 0 5px 0 var(--colorDark20, #afb2b6);
}
...
.checkbox-dark .k-checkbox:checked+.k-checkbox-label:after,
.checkbox-dark .k-checkbox:indeterminate+.k-checkbox-label:after {
    background: var(--colorDark30, #7e848c);
    color: var(--textColorDark40, #ffffff);
}

.k-grid table .k-checkbox:checked+.k-checkbox-label:before,
.k-grid table .k-checkbox:indeterminate+.k-checkbox-label:before,
.k-grid table .k-checkbox-label:hover:before,
.k-grid table .k-checkbox:checked+.k-checkbox-label:hover:before,
.k-grid table .k-checkbox:checked:hover+.k-checkbox-label:before,
.k-grid table .k-checkbox:hover+.k-checkbox-label:before,
.k-grid table .k-checkbox-label:active:before,
.k-grid table .k-checkbox:active+.k-checkbox-label:before,
.k-grid table .k-checkbox:focus+.k-checkbox-label:before,
.k-grid table .k-checkbox:hover+.k-checkbox-label:before,
.k-grid table .k-checkbox:checked+.k-checkbox-label:after,
.k-grid table .k-checkbox:indeterminate+.k-checkbox-label:after,
.k-grid table .k-checkbox-label:before {
    border-color: var(--textColor40, #ebebeb)
}
...
.k-radio:hover+.k-radio-label:before {
    box-shadow: 0 0 5px 0 var(--colorDefault30, #8d949b);
    border-color: var(--colorDefault30, #8d949b);
}
...
.option-dark .k-radio:checked+.k-radio-label:after {
    background-color: var(--colorDark30, #7e848c);
    border-color: var(--colorDark30, #7e848c);
}
...
.option-dark .k-radio:hover+.k-radio-label::before {
    box-shadow: 0 0 5px 0 var(--colorDark30, #7e848c);
    border-color: var(--colorDark30, #7e848c);
}
...
.k-scheduler .k-scheduler-toolbar ul.k-scheduler-views li.k-state-hover {
    border-color: var(--colorDefault40, #4e5d6c);
    box-shadow: none;
}
...
.k-scheduler .k-scheduler-toolbar ul li.k-state-hover {
    background: var(--colorPrimary30, #df691a);
    color: var(--textColorPrimary40, #ffffff);
}
...
.k-scheduler div.k-scheduler-footer ul li {
    background: var(--colorPrimary40, #df691a);
    border-color: var(--colorPrimary40, #df691a);
    color: var(--textColorPrimary40, #ffffff);
}
...
.k-separator,
.k-grid table {
    background: var(--backgroundColor40, #222222);
}
...
.k-grid table tbody tr:hover {
    background: var(--colorDefault30, #8d949b);
}
...
.k-scheduler-timelineview .k-today.k-nonwork-hour {
    background: var(--backgroundColor30, #81878e);
}

.k-scheduler-table .k-today,
.k-today>.k-scheduler-datecolumn,
.k-today>.k-scheduler-groupcolumn {
    background: var(--backgroundColor20, #b0b3b7);
}
