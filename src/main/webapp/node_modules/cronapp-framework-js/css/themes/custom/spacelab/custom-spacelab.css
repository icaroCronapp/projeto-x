...
:root {
    ...
    --colorPrimary: var(--colorPrimary40, #446e9b);
    --colorSuccess: var(--colorSuccess40, #3cb521);
    --colorCalm: var(--colorCalm40, #3399f3);
    --colorWarning: var(--colorWarning40, #d47500);
    --colorDanger: var(--colorDanger40, #cd0200);
    --colorLight: var(--colorLight50, #d0d0d0);
    --colorStable: var(--colorStable50, #d9d9d9);
    --colorRoyal: var(--colorRoyal40, #886aea);
    --colorDark: var(--colorDark40, #333333);

    /* Components - Checkbox */
    --checkboxDefault: var(--colorDefault40, #474949);
    --checkboxPrimary: var(--colorPrimary40, #446e9b);
    --checkboxSuccess: var(--colorSuccess40, #3cb521);
    --checkboxCalm: var(--colorCalm40, #3399f3);
    --checkboxWarning: var(--colorWarning40, #d47500);
    --checkboxDanger: var(--colorDanger40, #cd0200);
    --checkboxLight: var(--colorLight50, #d0d0d0);
    ...
    --comboboxSuccess: var(--colorSuccess40, #3cb521);
    --comboboxCalm: var(--colorCalm40, #3399f3);
    --comboboxWarning: var(--colorWarning40, #d47500);
    --comboboxDanger: var(--colorDanger40, #cd0200);
    --comboboxLight: var(--colorLight40, #eeeeee);
    ...
    --optionSuccess: var(--colorSuccess40, #3cb521);
    --optionCalm: var(--colorCalm40, #3399f3);
    --optionWarning: var(--colorWarning40, #d47500);
    --optionDanger: var(--colorDanger40, #cd0200);
    --optionLight: var(--colorLight50, #d0d0d0);
    ...
    --panelSuccess: var(--colorSuccess40, #3cb521);
    --panelCalm: var(--colorCalm40, #3399f3);
    --panelWarning: var(--colorWarning40, #d47500);
    --panelDanger: var(--colorDanger40, #cd0200);
    --panelLight: var(--colorLight40, #eeeeee);
...
.checkbox-light .k-checkbox:focus+.k-checkbox-label:before,
.checkbox-light .k-checkbox:hover+.k-checkbox-label:before {
    box-shadow: 0 0 5px 0 var(--colorLight60, #aeaeae);
}
...
.checkbox-light .k-checkbox:checked+.k-checkbox-label:after,
.checkbox-light .k-checkbox:indeterminate+.k-checkbox-label:after {
    background: var(--colorLight50, #d0d0d0);
...
.dynamic-image-container {
    border: 2px dashed var(--colorDefault70, #272828);
    padding: 10px;
}
...
.k-grid-toolbar .k-button {
    border: 1px solid var(--colorDefault20, #b5b6b6);
}
...
.k-pager-wrap,
.k-grid-toolbar {
    background: var(--colorStable40, #fbfbfb);
}
...
#modalPassword .modal-footer .btn.btn-danger:hover {
    color: var(--textColorDefault40, #ffffff);
    background: linear-gradient(var(--colorDefault40, #474949), var(--colorDefault50, #3e4040) 50%, var(--colorDefault60, #343535));
}
...
.active-bar .btn.btn-default {
    background: linear-gradient(var(--colorSuccess30, #86c97f), var(--colorSuccess40, #3cb521) 50%, var(--colorSuccess50, #359e1d));
...
.k-scheduler .k-scheduler-toolbar {
    background: linear-gradient(var(--colorLight10, #fafafa), var(--colorLight40, #eeeeee) 50%, var(--colorLight40, #aeaeae));
    border-bottom: 1px solid var(--colorLight50, #d0d0d0);
}
...
.k-scheduler .k-scheduler-toolbar ul li.k-state-hover.k-nav-today a {
    color: var(--textColorPrimary40, #ffffff);
    background: linear-gradient(var(--colorPrimary30, #899cb7), var(--colorPrimary50, #3c6088) 50%, var(--colorPrimary60, #3c6088));
    border-color: var(--colorPrimary40, #446e9b);
}
...
td.k-state-focused.k-state-selected {
    box-shadow: inset 0 0 10px 3px var(--colorPrimary20, #d7d4d1);
    color: var(--textColor40, #666666);
}
...
.k-state-focused,
td.k-state-focused {
    box-shadow: inset 0 0 7px 0 var(--colorDefault40, #aea79f);
}
...
.k-calendar .k-footer .k-nav-today {
    background: linear-gradient(var(--colorLight10, #f2f2f2), var(--colorLight40, #eeeeee) 50%, var(--colorLight40, #aeaeae));
    color: var(--textColorLight40, #000000);
}
...
.k-calendar .k-footer .k-nav-today:hover {
    background: linear-gradient(var(--colorLight30, #f2f2f2), var(--colorLight50, #d0d0d0) 50%, var(--colorLight60, #aeaeae));
    box-shadow: none;
}
...
td.k-state-focused.k-state-selected,
.k-state-selected {
    box-shadow: inset 0 0 10px 3px var(--colorDefault30, #8a8b8b);
}

.k-calendar .k-today.k-state-selected.k-state-hover {
    background: var(--colorDefault10, #d9d9d9);
}

.k-calendar .k-content .k-other-month .k-link {
    color: var(--textColor30, #989898);
}
