@import 'panel-lumen.css';
@import 'navbar-lumen.css';
@import 'button-lumen.css';

/* Fonts */
@import '../../../fonts/SourceSansPro/SourceSansPro.css';
@import '../../../fonts/calibri/calibri.css';
...
:root {
    ...
    --colorDefault40: #f0f0f0;
    --colorDefault50: #d2d2d2;
    --colorDefault60: #b0b0b0;
    --colorDefault70: #838383;
    --textColorDefault10: #131313;
    --textColorDefault20: #191919;
    --textColorDefault30: #1e1e1e;
    --textColorDefault40: #222222;
    --textColorDefault50: #7f7f7f;
    --textColorDefault60: #afafaf;
    --textColorDefault70: #d6d6d6;

    /* Color - Primary - positive */
    --colorPrimary10: #d6e3ec;
    --colorPrimary20: #aecadd;
    --colorPrimary30: #7daecc;
    --colorPrimary40: #158cba;
    --colorPrimary50: #127ba3;
    --colorPrimary60: #0f6788;
    --colorPrimary70: #0c4d66;
    ...
    --colorSuccess10: #d6ebd7;
    --colorSuccess20: #b0dbb1;
    --colorSuccess30: #80c981;
    --colorSuccess40: #28b62c;
    --colorSuccess50: #239f27;
    --colorSuccess60: #1d8520;
    --colorSuccess70: #166418;
    ...
    --colorWarning10: #ffe1d6;
    --colorWarning20: #ffc7af;
    --colorWarning30: #ffaa7d;
    --colorWarning40: #ff851b;
    --colorWarning50: #df7418;
    --colorWarning60: #bb6114;
    --colorWarning70: #8c490f;
    ...
    --colorDanger10: #ffd8d7;
    --colorDanger20: #ffb4b2;
    --colorDanger30: #ff8884;
    --colorDanger40: #ff4136;
    --colorDanger50: #df392f;
    --colorDanger60: #bb3028;
    --colorDanger70: #8c241e;
    ...
    --colorLight60: #b4b4b4;
    --colorLight70: #878787;
    --textColorLight10: #131313;
    --textColorLight20: #191919;
    --textColorLight30: #1e1e1e;
    --textColorLight40: #222222;
    --textColorLight50: #7f7f7f;
    --textColorLight60: #afafaf;
    --textColorLight70: #d6d6d6;
    ...
    --btnDefault: var(--colorDefault40, #f0f0f0);
    --btnPrimary: var(--colorPrimary40, #158cba);
    --btnSuccess: var(--colorSuccess40, #28b62c);
    --btnCalm: var(--colorCalm40, #75caeb);
    --btnWarning: var(--colorWarning40, #ff851b);
    --btnDanger: var(--colorDanger40, #ff4136);
    --btnLight: var(--colorLight40, #f6f6f6);
    --btnStable: var(--colorStable40, #f8f8f8);
    --btnRoyal: var(--colorRoyal40, #886aea);
    --btnDark: var(--colorDark40, #555555);
    ...
    --borderBtnDefault: var(--colorDefault50, #d2d2d2);
    --borderBtnPrimary: var(--colorPrimary60, #0f6788);
    --borderBtnSuccess: var(--colorSuccess50, #239f27);
    --borderBtnCalm: var(--colorCalm50, #66b1ce);
    --borderBtnWarning: var(--colorWarning50, #df7418);
    --borderBtnDanger: var(--colorDanger50, #df392f);
    --borderBtnLight: var(--colorLight50, #d7d7d7);
    --borderBtnStable: var(--colorStable50, #d9d9d9);
    --borderBtnRoyal: var(--colorRoyal50, #775dcd);
    --borderBtnDark: var(--colorDark60, #3e3e3e);

    /* Components - Text color */
    --colorDefault: var(--colorDefault50, #d2d2d2);
    --colorPrimary: var(--colorPrimary40, #158cba);
    --colorSuccess: var(--colorSuccess40, #28b62c);
    --colorCalm: var(--colorCalm40, #75caeb);
    --colorWarning: var(--colorWarning40, #ff851b);
    --colorDanger: var(--colorDanger40, #ff4136);
    --colorLight: var(--colorLight50, #d7d7d7);
    --colorStable: var(--colorStable50, #d9d9d9);
    --colorRoyal: var(--colorRoyal40, #886aea);
    --colorDark: var(--colorDark40, #555555);

    /* Components - Checkbox */
    --checkboxDefault: var(--colorDefault50, #d2d2d2);
    --checkboxPrimary: var(--colorPrimary40, #158cba);
    --checkboxSuccess: var(--colorSuccess40, #28b62c);
    --checkboxCalm: var(--colorCalm40, #75caeb);
    --checkboxWarning: var(--colorWarning40, #ff851b);
    --checkboxDanger: var(--colorDanger40, #ff4136);
    --checkboxLight: var(--colorLight50, #d7d7d7);
    --checkboxStable: var(--colorStable50, #d9d9d9);
    --checkboxRoyal: var(--colorRoyal40, #886aea);
    --checkboxDark: var(--colorDark40, #555555);

    --borderCheckboxDefault: var(--colorDefault50, #d2d2d2);
    --borderCheckboxPrimary: var(--colorPrimary40, #158cba);
    --borderCheckboxSuccess: var(--colorSuccess40, #28b62c);
    --borderCheckboxCalm: var(--colorCalm40, #75caeb);
    --borderCheckboxWarning: var(--colorWarning40, #ff851b);
    --borderCheckboxDanger: var(--colorDanger40, #ff4136);
    --borderCheckboxLight: var(--colorLight50, #d7d7d7);
    ...
    /* Components - Combobox */
    --comboboxDefault: var(--colorDefault40, #f0f0f0);
    --comboboxPrimary: var(--colorPrimary40, #158cba);
    --comboboxSuccess: var(--colorSuccess40, #28b62c);
    --comboboxCalm: var(--colorCalm40, #75caeb);
    --comboboxWarning: var(--colorWarning40, #ff851b);
    --comboboxDanger: var(--colorDanger40, #ff4136);
    --comboboxLight: var(--colorLight40, #f6f6f6);
    --comboboxStable: var(--colorStable40, #f8f8f8);
    --comboboxRoyal: var(--colorRoyal40, #886aea);
    --comboboxDark: var(--colorDark40, #555555);

    --borderComboboxDefault: var(--colorDefault50, #d2d2d2);
    --borderComboboxPrimary: var(--colorPrimary40, #158cba);
    --borderComboboxSuccess: var(--colorSuccess40, #28b62c);
    --borderComboboxCalm: var(--colorCalm40, #75caeb);
    --borderComboboxWarning: var(--colorWarning40, #ff851b);
    --borderComboboxDanger: var(--colorDanger40, #ff4136);
    --borderComboboxLight: var(--colorLight50, #d7d7d7);
    --borderComboboxStable: var(--colorStable50, #d9d9d9);
    --borderComboboxRoyal: var(--colorRoyal40, #886aea);
    --borderComboboxDark: var(--colorDark40, #555555);

    /* Components - Radio input */
    --optionDefault: var(--colorDefault50, #d2d2d2);
    --optionPrimary: var(--colorPrimary40, #158cba);
    --optionSuccess: var(--colorSuccess40, #28b62c);
    --optionCalm: var(--colorCalm40, #75caeb);
    --optionWarning: var(--colorWarning40, #ff851b);
    --optionDanger: var(--colorDanger40, #ff4136);
    --optionLight: var(--colorLight50, #d7d7d7);
    --optionStable: var(--colorStable50, #d9d9d9);
    --optionRoyal: var(--colorRoyal40, #886aea);
    --optionDark: var(--colorDark40, #555555);

    --borderOptionDefault: var(--colorDefault50, #d2d2d2);
    --borderOptionPrimary: var(--colorPrimary40, #158cba);
    --borderOptionSuccess: var(--colorSuccess40, #28b62c);
    --borderOptionCalm: var(--colorCalm40, #75caeb);
    --borderOptionWarning: var(--colorWarning40, #ff851b);
    --borderOptionDanger: var(--colorDanger40, #ff4136);
    --borderOptionLight: var(--colorLight50, #d7d7d7);
    ...
    --panelDanger: var(--colorDanger40, #ff4136);
    --panelLight: var(--colorLight40, #f6f6f6);
    ...
    --borderPanelDanger: var(--colorDanger40, #ff4136);
    --borderPanelLight: var(--colorLight40, #f6f6f6);
    --borderPanelStable: var(--colorStable50, #d9d9d9);
    --borderPanelRoyal: var(--colorRoyal40, #886aea);
    --borderPanelDark: var(--colorDark40, #555555);
...
.checkbox-default .k-checkbox:focus+.k-checkbox-label:before,
.checkbox-default .k-checkbox:hover+.k-checkbox-label:before {
    box-shadow: 0 0 5px 0 var(--colorDefault60, #b0b0b0);
}
...
.k-grid-toolbar .k-button {
    border: 1px solid var(--colorDefault50, #d2d2d2);
}
...
.bg-login #container-second {
    background: linear-gradient(-140deg, var(--colorPrimary20, #aecadd), var(--colorPrimary30, #7daecc), var(--colorPrimary40, #158cba), var(--colorPrimary50, #127ba3), var(--colorPrimary60, #0f6788));
}
...
.bg-login #container-first {
    ...
    border-color: var(--colorDefault40, #f0f0f0);
}
...
.login-view .btn.btn-default:hover {
    color: var(--textColorPrimary40, #ffffff);
    background: var(--colorPrimary50, #4b58a6);
...
.ctn-tab .nav-tabs li a:hover {
    color: var(--textColorLight30, #98978b);
    background: var(--colorLight40, #f8f5f0);
    border: 1px solid var(--colorLight50, #98978b);
}
...
.ctn-tab .nav-tabs li a {
    ...
    border: 1px solid var(--colorLight50, #d7d7d7);
    margin-top: 2px;
    bottom: 1px;
}
...
.ctn-tab .nav-tabs li.active {
    ...
    background: var(--backgroundColor40, #ffffff);
    bottom: 1px;
    border-bottom: 1px solid var(--backgroundColor40, #ffffff);
    padding-bottom: 8px;
}

.ctn-tab .nav-tabs {
    border-bottom: 1px solid var(--colorLight50, #d7d7d7);
    display: flex;
...
.jumbotron {
    ...
    border: 1px solid var(--colorDefault40, #f0f0f0);
    border-top: 4px solid var(--colorDefault40, #f0f0f0);
}
...
.dynamic-image-container {
    border: 2px dashed var(--colorDefault70, #838383);
}
...
.active-bar .btn.btn-default:hover {
    color: var(--textColorSuccess40, #ffffff);
    background: var(--colorSuccess50, #2db353);
    border-color: transparent;
    outline: none;
}
...
.k-calendar .k-footer .k-nav-today:hover {
    background: var(--colorPrimary60, #0f6788);
    box-shadow: none;
}

.k-calendar th {
    background: var(--backgroundColor50, #c7c9ce);
}
...
.k-state-selected {
    box-shadow: inset 0 0 10px 3px var(--colorPrimary40, #158cba);
}
...
.k-calendar .k-today.k-state-selected.k-state-hover {
    background: var(--colorPrimary10, #d6e3ec);
}
...
.checkbox-light .k-checkbox:focus+.k-checkbox-label:before,
.checkbox-light .k-checkbox:hover+.k-checkbox-label:before,
.checkbox-light .k-radio:focus+.k-radio-label:before,
.checkbox-light .k-radio:hover+.k-radio-label:before {
    box-shadow: 0 0 5px 0 var(--colorLight50, #d7d7d7);
    border-color: var(--colorLight50, #d7d7d7);
}
...
.checkbox-default .k-checkbox:focus+.k-checkbox-label:before,
.checkbox-default .k-checkbox:hover+.k-checkbox-label:before,
.checkbox-default .k-radio:focus+.k-radio-label:before,
.checkbox-default .k-radio:hover+.k-radio-label:before {
    box-shadow: 0 0 5px 0 var(--colorDefault50, #d2d2d2);
    border-color: var(--colorDefault50, #d2d2d2);
}
...
.k-state-focused,
td.k-state-focused {
    box-shadow: inset 0 0 7px 0 var(--colorDefault40, #f0f0f0);
}
