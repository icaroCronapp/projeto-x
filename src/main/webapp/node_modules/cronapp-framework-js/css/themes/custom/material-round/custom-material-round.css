@import 'navbar-material-round.css';
@import 'panel-material-round.css';
@import 'button-material-round.css';
@import 'grid-material-round.css';
...
:root {
    ...
    /* Components - Combobox */
    --comboboxDefault: var(--backgroundColor50, #d4d4d4);
    --comboboxPrimary: var(--colorPrimary40, #68afd9);
    --comboboxSuccess: var(--colorSuccess40, #62a86b);
    --comboboxCalm: var(--colorCalm40, #8ac8ee);
    --comboboxWarning: var(--colorWarning40, #e98053);
    --comboboxDanger: var(--colorDanger40, #e34646);
    --comboboxLight: var(--colorLight40, #eadede);
    --comboboxStable: var(--colorStable40, #cfcfcf);
    --comboboxRoyal: var(--colorRoyal40, #2f1a4f);
    --comboboxDark: var(--colorDark40, #343434);

    --borderComboboxDefault: var(--backgroundColor60, #b1b1b1);
    --borderComboboxPrimary: var(--colorPrimary50, #478fba);
    --borderComboboxSuccess: var(--colorSuccess50, #56935e);
    --borderComboboxCalm: var(--colorCalm50, #64acd7);
    --borderComboboxWarning: var(--colorWarning50, #dc7144);
    --borderComboboxDanger: var(--colorDanger50, #d43131);
    --borderComboboxLight: var(--colorLight50, #cdc2c2);
    --borderComboboxStable: var(--colorStable50, #b5b5b5);
    --borderComboboxRoyal: var(--colorRoyal50, #291745);
    --borderComboboxDark: var(--colorDark50, #2e2e2e);

    /* Components - Radio input */
    --optionDefault: var(--colorDefault40, #442b69);
    --optionPrimary: var(--colorPrimary40, #68afd9);
    --optionSuccess: var(--colorSuccess40, #62a86b);
    --optionCalm: var(--colorCalm40, #8ac8ee);
    --optionWarning: var(--colorWarning40, #e98053);
    --optionDanger: var(--colorDanger40, #e34646);
    --optionLight: var(--colorLight40, #eadede);
    --optionStable: var(--colorStable40, #cfcfcf);
    --optionRoyal: var(--colorRoyal40, #2f1a4f);
    --optionDark: var(--colorDark40, #343434);
    ...
    /* Components - Panel */
    --panelDefault: var(--colorPrimary40, #68afd9);
    --panelPrimary: var(--colorDefault40, #442b69);
    --panelSuccess: var(--colorSuccess10, #dce8dd);
    --panelCalm: var(--colorDefault10, #d9d7dd);
    --panelWarning: var(--colorWarning10, #f9e1da);
    --panelDanger: var(--colorDanger10, #f7d9d9);
    --panelLight: var(--colorLight50, #cdc2c2);
    --panelStable: var(--colorStable50, #b5b5b5);
    --panelRoyal: var(--colorRoyal50, #291745);
    --panelDark: var(--colorDark50, #2e2e2e);
    ...
    --borderPanelDark: var(--colorDark60, #1f1f1f);
...
.form-control {
    ...
    border: none;
    border-radius: 0;
    border-bottom: 1px solid var(--textColor40, #434343);
    outline: none;
    width: 100%;
    box-shadow: none;
}
...
.cardinput button i,
.input-group.layout-template-modern .k-button i:hover {
...
.bootstrap-datetimepicker-widget.dropdown-menu {
    padding: 20px;
    background: var(--backgroundColor50, #f2f2f2);
}
...
.bootstrap-datetimepicker-widget table thead tr:first-child th {
    color: var(--textColor40, #434343);
    background: var(--backgroundColor50, #d4d4d4);
    font-weight: 600;
}
...
.bootstrap-datetimepicker-widget.dropdown-menu.bottom:after {
    border-bottom-color: var(--backgroundColor50, #d4d4d4);
}

.bootstrap-datetimepicker-widget.dropdown-menu.top:after {
    border-top-color: var(--backgroundColor50, #d4d4d4);
}
...
.bg-login #container-first .btn-login:active {
    background: var(--colorDefault60, #32204d);
}

btn k-button btn-block btn-primary crn-button-signup-register {
    background: var(--colorDefault40, #442b69);
}

label.labelCollapsibleMenu {
    background: var(--textColorDefault30, #dfdfdf);
}
...
.color-primary:focus,
.color-primary:hover {
    color: var(--colorPrimary50, #478fba);
}
...
.color-stable:focus,
.color-stable:hover {
    color: var(--colorStable60, #b8b8b8);
}
...
.combobox-default .k-multiselect .k-button {
    background: var(--colorDefault40, #442b69);
    border-color: var(--colorDefault50, #3c265c);
    color: var(--textColorDefault40, #fffef9);
}
...
.combobox-primary .k-multiselect .k-button {
    background: var(--colorPrimary40, #68afd9);
    border-color: var(--colorPrimary5, #478fba);
    color: var(--textColorPrimary40, #fffef9);
}
...
.combobox-success .k-multiselect .k-button {
    background: var(--colorSuccess40, #62a86b);
    border-color: var(--colorSuccess50, #56935e);
    color: var(--textColorSuccess40, #fffef9);
}
...
.combobox-info .k-multiselect .k-button {
    background: var(--colorCalm40, #8ac8ee);
    border-color: var(--colorCalm50, #64acd7);
    color: var(--textColorCalm40, #fffef9);
}
...
.combobox-warning .k-multiselect .k-button {
    background: var(--colorWarning40, #e98053);
    border-color: var(--colorWarning50, #dc7144);
    color: var(--textColorWarning40, #fffef9);
}
...
.combobox-danger .k-multiselect .k-button {
    background: var(--colorDanger40, #e34646);
    border-color: var(--colorDanger50, #d43131);
    color: var(--textColorDanger40, #fffef9);
}
...
.combobox-royal .k-multiselect .k-button {
    background: var(--colorRoyal40, #2f1a4f);
    border-color: var(--colorRoyal50, #291745);
    color: var(--textColorRoyal40, #ffffff);
}

/*Dark*/
.combobox-dark .k-multiselect .k-button {
    border-color: var(--colorDark50, #2e2e2e);
    background: var(--colorDark40, #343434);
    color: var(--textColorDark40, #fffef9);
}
...
/*Buttons form*/
/*Save*/
#varsgrid1568-update-1d4e5d7b-dca8-4a1d-90fd-72648cf5dc8d {
    background: var(--colorDefault20, #b9abce);
}

#varsgrid1568-update-1d4e5d7b-dca8-4a1d-90fd-72648cf5dc8d:hover {
    background: var(--colorDefault40, #442b69);
}

#varsgrid1568-update-1d4e5d7b-dca8-4a1d-90fd-72648cf5dc8d:active {
    background: var(--colorDefault60, #32204d);
}

/*Cancel*/
#varsgrid1568-cancel-1d4e5d7b-dca8-4a1d-90fd-72648cf5dc8d {
    background: var(--colorDanger40, #e34646);
}

#varsgrid1568-cancel-1d4e5d7b-dca8-4a1d-90fd-72648cf5dc8d:hover {
    background: var(--colorDanger50, #d43131);
}

#varsgrid1568-cancel-1d4e5d7b-dca8-4a1d-90fd-72648cf5dc8d:active {
...
.k-i-calendar:before,
a.k-link,
.k-kicon.k-i-reload::before {
    color: var(--textColorDefault40, #fffef9);
}

.k-scheduler-navigation .k-nav-next .k-link:hover,
...
cron-scheduler .k-link:link {
    ...
    border-color: var(--textColorDefault40, #fffef9);
}

.k-scheduler-toolbar>ul>li {
    border-color: var(--backgroundColor, #f2f2f2);
}
...
.k-scheduler-toolbar .k-nav-current .k-lg-date-format:hover {
    color: var(--colorDefault20, #b9abce);
}
...
.k-webkit .k-scheduler-toolbar>ul li:first-child .k-link:hover {
    background: var(--colorDefault20, #b9abce);
    color: var(--textColorDefault40, #fffef9);
}
...
.k-scheduler div.k-scheduler-footer ul li:focus,
...
.btn.k-button.btn-block.btn-primary.crn-button-signup-register:hover {
    background: var(--colorDefault20, #b9abce);
    color: var(--textColorDanger40, #fffef9);
}

.btn.k-button.btn-block.btn-primary.crn-button-signup-register:active {
    background: var(--colorDefault60, #32204d);
    color: var(--textColorDanger40, #fffef9);
}
...
/*Button serie edit*/
.k-button.kscheduler-Editarocorrênciaatual {
    background: var(--colorDefault40, #442b69);
    box-shadow: 0px 2px 2px 0px rgba(0, 0, 0, 0.25);
}

.k-button.kscheduler-Editarocorrênciaatual:hover {
    background: var(--colorDefault20, #b9abce);
    box-shadow: 0px 2px 2px 0px rgba(0, 0, 0, 0.25);
}

.k-button.kscheduler-Editarocorrênciaatual:active {
    background: var(--colorDefault60, #32204d);
    box-shadow: 0px 2px 2px 0px rgba(0, 0, 0, 0.25);
}
...
.btn.btn-primary:active {
    background: var(--colorPrimary60, #4c809f);
}
...
.k-button.k-primary.k-scheduler-update:active {
    background: var(--colorDefault60, #32204d);
    border-radius: 10px;
}