...
.btn.btn-default:hover {
    ...
    background: var(--colorDefault50, #363733);
}
...
.btn.btn-default:active {
    background: var(--colorDefault30, #878785);
    color: var(--textColorDefault40, #ffffff);
}
...
.btn.btn-primary:hover {
    background: var(--colorPrimary50, #2c5177);
...
.k-button.k-primary:active {
    background: var(--colorPrimary30, #8394ab);
    color: var(--textColorPrimary40, #ffffff);
}
...
.btn.btn-success:hover {
    background: var(--colorSuccess50, #81ac42);
...
.k-button.k-success:active {
    background: var(--colorSuccess30, #b2d48c);
    color: var(--textColorSuccess40, #ffffff);
}
...
.btn.btn-warning:hover {
    background: var(--colorWarning50, #d66d35);
...
.k-button.k-warning:active {
    background: var(--colorWarning30, #f7a486);
    color: var(--textColorWarning40, #ffffff);
}
...
.btn.btn-info:focus,
.btn.btn-info:hover {
    background: var(--colorCalm50, #2496c4);
...
.k-button.k-info:active {
    background: var(--colorCalm30, #80c2e8);
    color: var(--textColorCalm40, #ffffff);
}
...
.btn.btn-dark:focus,
.btn.btn-dark:hover {
    background: var(--colorDark50, #363733);
...
.k-button.k-dark:active {
    background: var(--colorDark30, #878785);
    color: var(--textColorDark40, #ffffff);
}