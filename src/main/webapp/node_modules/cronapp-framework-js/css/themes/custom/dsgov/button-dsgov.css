...
.btn.btn-success:active {
    background: var(--colorSuccess30, #168821);
    border-color: transparent;
...
.btn.btn-info.active,
.btn.btn-info:active {
    background: var(--colorCalm30, #168821);
    border-color: transparent;
...
.btn.btn-warning:active {
    background: var(--colorWarning30, #168821);
    border-color: transparent;
...
.btn.btn-danger:active {
    background: var(--colorDanger30, #168821);
    border-color: transparent;
...
.btn.btn-light:active {
    background: var(--colorLight30, #168821);
    border-color: transparent;
