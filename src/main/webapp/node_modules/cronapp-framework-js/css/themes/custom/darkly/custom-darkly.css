...
:root {
    ...
    /* Background Login */
    --backgroundLogin10: #d6d6d6;
    --backgroundLogin20: #afafaf;
    --backgroundLogin30: #7f7f7f;
    --backgroundLogin40: #222222;
    --backgroundLogin50: #1e1e1e;
    --backgroundLogin60: #191919;
    --backgroundLogin70: #131313;
    ...
    --btnPrimary: var(--colorPrimary40, #375a7f);
    --btnSuccess: var(--colorSuccess40, #00bc8c);
    --btnCalm: var(--colorCalm40, #3498db);
    --btnWarning: var(--colorWarning40, #f39c12);
    --btnDanger: var(--colorDanger40, #e74c3c);
    --btnLight: var(--colorLight40, #adb5bd);
    ...
    --colorSuccess: var(--colorSuccess40, #00bc8c);
    --colorCalm: var(--colorCalm40, #3498db);
    --colorWarning: var(--colorWarning40, #f39c12);
    --colorDanger: var(--colorDanger40, #e74c3c);
    --colorLight: var(--colorLight40, #adb5bd);
    --colorStable: var(--colorStable40, #ffc900);
    --colorRoyal: var(--colorRoyal40, #886aea);
    --colorDark: var(--colorDark30, #828282);

    /* Components - Checkbox */
    --checkboxDefault: var(--colorDefault50, #3c3c3c);
    --checkboxPrimary: var(--colorPrimary40, #375a7f);
    --checkboxSuccess: var(--colorSuccess40, #00bc8c);
    --checkboxCalm: var(--colorCalm40, #3498db);
    --checkboxWarning: var(--colorWarning40, #f39c12);
    --checkboxDanger: var(--colorDanger40, #e74c3c);
    --checkboxLight: var(--colorLight50, #979ea5);
    --checkboxStable: var(--colorStable40, #f8f8f8);
    --checkboxRoyal: var(--colorRoyal40, #886aea);
    --checkboxDark: var(--colorDark30, #828282);
    ...
    /* Components - Combobox */
    --comboboxDefault: var(--colorDefault40, #444444);
    --comboboxPrimary: var(--colorPrimary40, #375a7f);
    --comboboxSuccess: var(--colorSuccess40, #00bc8c);
    --comboboxCalm: var(--colorCalm40, #3498db);
    --comboboxWarning: var(--colorWarning40, #f39c12);
    --comboboxDanger: var(--colorDanger40, #e74c3c);
    --comboboxLight: var(--colorLight40, #adb5bd);
    --comboboxStable: var(--colorStable40, #f8f8f8);
    --comboboxRoyal: var(--colorRoyal40, #886aea);
    --comboboxDark: var(--colorDark40, #303030);

    --borderComboboxDefault: var(--colorDefault50, #555555);
    ...
    --borderComboboxRoyal: var(--colorRoyal50, #9933cc);
    --borderComboboxDark: var(--colorDark50, #adafae);

    /* Components - Radio input */
    --optionDefault: var(--colorDefault50, #3c3c3c);
    --optionPrimary: var(--colorPrimary40, #375a7f);
    --optionSuccess: var(--colorSuccess40, #00bc8c);
    --optionCalm: var(--colorCalm40, #3498db);
    --optionWarning: var(--colorWarning40, #f39c12);
    --optionDanger: var(--colorDanger40, #e74c3c);
    --optionLight: var(--colorLight50, #979ea5);
    --optionStable: var(--colorStable40, #f8f8f8);
    --optionRoyal: var(--colorRoyal40, #886aea);
    --optionDark: var(--colorDark30, #828282);
    ...
    /* Components - Panel */
    --panelDefault: var(--colorPrimary40, #375a7f);
    --panelPrimary: var(--colorDefault40, #444444);
    --panelSuccess: var(--colorSuccess40, #00bc8c);
    --panelCalm: var(--colorCalm40, #3498db);
    --panelWarning: var(--colorWarning40, #f39c12);
    --panelDanger: var(--colorDanger40, #e74c3c);
    --panelLight: var(--colorLight40, #adb5bd);
    --panelStable: var(--colorStable40, #f8f8f8);
    --panelRoyal: var(--colorRoyal40, #886aea);
    --panelDark: var(--colorDark30, #828282);
...
a.default,
.color-default {
    color: var(--colorDefault30, #898989);
}

a.default:hover,
.color-default:hover {
    color: var(--colorDefault20, #898989);
}
...
a:hover {
    color: var(--colorSuccess60, #008a67);
}
...
.option-light .k-radio-label:before {
    border-color: var(--colorLight40, #adb5bd);
}
...
.option-dark .k-radio:hover+.k-radio-label::before {
    box-shadow: 0 0 5px 0 var(--colorDark30, #828282);
    border-color: var(--colorDark30, #828282);
}
...
.checkbox-default .k-checkbox-label:before {
    border-color: var(--colorDefault50, #3c3c3c);
}
...
.checkbox-default .k-checkbox:focus+.k-checkbox-label:before,
.checkbox-default .k-checkbox:hover+.k-checkbox-label:before {
    box-shadow: 0 0 5px 0 var(--colorDefault60, #323232);
}
...
.checkbox-default .k-checkbox:checked+.k-checkbox-label:after,
.checkbox-default .k-checkbox:indeterminate+.k-checkbox-label:after {
    background: var(--colorDefault50, #3c3c3c);
...
.checkbox-light .k-checkbox-label:before {
    border-color: var(--colorLight50, #979ea5);
}
...
.checkbox-light .k-checkbox:focus+.k-checkbox-label:before,
.checkbox-light .k-checkbox:hover+.k-checkbox-label:before {
    box-shadow: 0 0 5px 0 var(--colorLight60, #7f858a);
}
...
.checkbox-light .k-checkbox:checked+.k-checkbox-label:after,
.checkbox-light .k-checkbox:indeterminate+.k-checkbox-label:after {
    background: var(--colorLight50, #979ea5);
...
.checkbox-dark .k-checkbox:focus+.k-checkbox-label:before,
.checkbox-dark .k-checkbox:hover+.k-checkbox-label:before {
    box-shadow: 0 0 5px 0 var(--colorDark20, #b1b1b1);
}
...
.checkbox-dark .k-checkbox:checked+.k-checkbox-label:after,
.checkbox-dark .k-checkbox:indeterminate+.k-checkbox-label:after {
    background: var(--colorDark30, #828282);
    color: var(--textColorDark40, #ffffff);
}

.k-grid-header .k-checkbox:checked+.k-checkbox-label:before,
.k-grid-header .k-checkbox:indeterminate+.k-checkbox-label:before,
.k-grid-header .k-checkbox-label:hover:before,
.k-grid-header .k-checkbox:checked+.k-checkbox-label:hover:before,
.k-grid-header .k-checkbox:checked:hover+.k-checkbox-label:before,
.k-grid-header .k-checkbox:hover+.k-checkbox-label:before,
.k-grid-header .k-checkbox-label:active:before,
.k-grid-header .k-checkbox:active+.k-checkbox-label:before,
.k-grid-header .k-checkbox:focus+.k-checkbox-label:before,
.k-grid-header .k-checkbox:hover+.k-checkbox-label:before,
.k-grid-header .k-checkbox:checked+.k-checkbox-label:after,
.k-grid-header .k-checkbox:indeterminate+.k-checkbox-label:after,
.k-grid-header .k-checkbox-label:before {
    border-color: var(--colorDefault30, #898989);
}
...
.k-grid-header .k-checkbox:focus+.k-checkbox-label:before,
.k-grid-header .k-checkbox:hover+.k-checkbox-label:before{
    box-shadow: 0 0 5px 0 var(--colorDefault30, #898989);
}
...
.k-grid-header .k-checkbox:checked+.k-checkbox-label:after,
.k-grid-header .k-checkbox:indeterminate+.k-checkbox-label:after{
    background: var(--colorDefault30, #898989);
    color: var(--textColorDefault40, #ffffff);
}
...
.bg-login #container-second {
    background: linear-gradient(-140deg, var(--colorPrimary20, #b2bac5), var(--colorPrimary30, #8492a6), var(--colorPrimary40, #375a7f), var(--colorPrimary50, #304f6f), var(--colorPrimary60, #28425d));
}
...
.bg-login #container-first #crn-botao-signup:hover {
    color: var(--colorSuccess50, #00bc8c);
}
...
/* Banner */
.jumbotron {
    background: var(--colorDefault60, #323232);
}
...
.dynamic-image-container {
    border: 2px dashed var(--colorDefault10, #d9d9d9);
    padding: 10px;
}
...
.active-bar .btn.btn-default {
    background: var(--colorSuccess40, #00bc8c);
    border-color: transparent;
...
.active-bar .btn.btn-default:hover {
    background: var(--colorSuccess50, #00a57b);
    border-color: transparent;
    color: var(--textColorSuccess40, #ffffff);
}
...
.table-hover>tbody>tr:hover {
    ...
    color: var(--colorDefault40, #444444);
}
...
.k-scheduler .k-scheduler-toolbar ul.k-scheduler-views li.k-state-hover {
    border-color: var(--backgroundColor30, #7f7f7f);
    box-shadow: none;
}
...
.k-scheduler .k-scheduler-toolbar ul li.k-state-hover {
    background: var(--colorPrimary30, #8492a6);
    color: var(--textColorPrimary40, #ffffff);
}
...
.k-scheduler-toolbar .k-nav-current.k-state-hover .k-sm-date-format {
    color: var(--colorPrimary30, #8492a6);
}
...
.k-grid tr.k-state-selected:hover td {
    background: var(--colorSuccess40, #00bc8c);
    border-color: var(--colorSuccess30, #7bceae);
}
...
td.k-state-focused.k-state-selected {
    box-shadow: inset 0 0 2px 0 var(--colorSuccess30, #7bceae), inset 0 0 7px 0 var(--colorSuccess40, #00bc8c);
    background: transparent;
}
...
.k-scheduler-timelineview .k-today.k-nonwork-hour {
    background: var(--backgroundColor30, #7f7f7f);
}

.k-scheduler-table .k-today,
.k-today>.k-scheduler-datecolumn,
.k-today>.k-scheduler-groupcolumn {
    background: var(--backgroundColor20, #afafaf);
}
...
.bootstrap-datetimepicker-widget a[data-action] {
    color: var(--colorPrimary40, #375a7f);
}

.bootstrap-datetimepicker-widget.dropdown-menu {
    background: var(--colorNeutral00, #ffffff);
    color: var(--backgroundColor40, #222222);
}
...
.k-calendar .k-footer .k-nav-today:hover {
    background: var(--colorPrimary60, #28425d);
    box-shadow: none;
}

.k-calendar th {
    background: var(--colorPrimary10, #d7dbe0);
}
...
td.k-state-focused.k-state-selected,
.k-state-selected {
    box-shadow: inset 0 0 10px 3px var(--colorPrimary30, #8492a6);
}
